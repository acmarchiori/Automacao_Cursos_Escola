...
def criar_engine():
    ...
    connection_string = (
        ...
        f"driver={driver}&Encrypt=yes&TrustServerCertificate=yes&Connection Timeout=30"
    )
    return create_engine(connection_string)

def inserir_conteudo_aula(engine, id_aula, conteudo):
    with engine.begin() as conn:
        query = text("UPDATE T_AULAS SET CONTEUDO_AULA = :conteudo WHERE ID = :id_aula")
...
def main():
    ...
    caminho_arquivo_html = "/home/acmarchiori/Área de Trabalho/HTLM_LITERATURA/PORT_EM1_LIT_TROVADORISMO_CONT_N2_V1/PORT_EM1_LIT_TROVADORISMO_CONT_N2_V1.html"  # Caminho para o arquivo HTML
